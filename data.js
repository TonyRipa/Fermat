...
class Data {
	...
	static eqn() {
		return ['X=0','X=1','X+0=0','X+0=1','X+1=0','X+1=1','X*0=0','X*0=1','X*1=0','X*1=1','X*2=1','M*h=(2*x+h)*h','h*M=(2*x+h)*h','X=e-e','Y=2*3','Y=x*3',              '0*1=0','0*X=0','(2*x+h)*h=M*h',                                'Y=X*3','X=2*X','X=X*2','X*2=X','2*X=X',        'X=X',              'Y*X=1']
	}
